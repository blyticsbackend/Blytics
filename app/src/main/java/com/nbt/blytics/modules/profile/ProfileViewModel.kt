...
class ProfileViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun registerBVN(
        user_id: String, bvn_number: String, user_token: String, document1: File, document2: File
    ) {
        ...
        val doc1: MultipartBody.Part = MultipartBody.Part.createFormData(
            "identity_proof_document", "identity_proof.${document1.extension}", requestFile
        )
        ...
        val doc2: MultipartBody.Part = MultipartBody.Part.createFormData(
            "address_proof_document", "address_proof.${document2.extension}", requestFile2
        )
        val request =
            service.registerBVN(userID, bvnNumber, userToken, idProof, addressProof, doc1, doc2)
    ...
    fun updateMobile(userId: String, userToke: String, mobileNumber: String, deviceToken: String) {
        val mobileRequest = UpdateMobileRequest(userId, userToke, mobileNumber, true, deviceToken, "")
