...
class DefaultAnimation(scrollOrientation: StackLayoutManager.ScrollOrientation, visibleCount: Int) : StackAnimation(scrollOrientation, visibleCount) {
    ...
    private fun setItemPivotXY(scrollOrientation: StackLayoutManager.ScrollOrientation, view: View) {
    ...
    private fun rotationFirstVisibleItem(scrollOrientation: StackLayoutManager.ScrollOrientation, view: View, rotation: Float) {
        when(scrollOrientation) {
