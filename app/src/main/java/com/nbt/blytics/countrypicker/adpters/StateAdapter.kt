 ...
 */
class StateAdapter (val context:Context, val  list:MutableList<CountriesStates.Country.State>, val callback:(Int)->Unit):RecyclerView.Adapter<StateAdapter.CountryViewHolder>(){
   inner class CountryViewHolder(val binding: RowCountryStateAdpterBinding):RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onBindViewHolder(holder: CountryViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            selectedCountryTv.text = data.stateName
